...
namespace MindKey.Server.Migrations
{
    ...
    [Migration("20230331002026_PersonProfilePictureAdded")]
    partial class PersonProfilePictureAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MindKey.Shared.Models.ChatLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MindKey.Shared.Models.MindKey.Tag", b =>
                {
                    b.HasOne("MindKey.Shared.Models.MindKey.Idea", null)
                        .WithMany("Tags")
                        .HasForeignKey("IdeaId");
                });
